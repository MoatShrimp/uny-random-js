...
describe('.rangeFloat vs. UnityEngine.Random.range', () => {
  ...
  ])('should generate the same float (error margin 0.00001%) from small float range [$min, $max]  - [Seed: $init]', ({ init, min, max, expected }) => {
  ...
  ])('should generate the same float (error margin 0.00001%) from small float range [$min, $max], when max & min is reversed - [Seed: $init]', ({ init, min, max, expected }) => {
  ...
  ])('should generate the same float (error margin 0.00001%) from large float range [$min, $max] - [Seed: $init]', ({ init, min, max, expected }) => {
