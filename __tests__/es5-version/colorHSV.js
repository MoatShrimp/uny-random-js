...
describe('.colorHSV vs. UnityEngine.Random.ColorHSV', () => {
  ...
  ])('should generate the same Color (error margin 0.00005%) - [Seed: $init]', ({ init, expected }) => {
  ...
  test.each([
    {
      ...
      hueMin: 0.4112355,
      hueMax: 0.9567251,
      saturationMin: 0.5220811,
      saturationMax: 0.8733672,
      valueMin: 0.03283918,
      valueMax: 0.6109516,
    ...
    },
    {
      ...
      hueMin: 0.1589235,
      hueMax: 0.8536462,
      saturationMin: 0.3470565,
      saturationMax: 0.7604165,
      valueMin: 0.5185792,
      valueMax: 0.9612151,
    ...
    },
    {
      ...
      hueMin: 0,
      hueMax: 0.2928473,
      saturationMin: 0.5587336,
      saturationMax: 1,
      valueMin: 0,
      valueMax: 1,
      expected: { r: 0.1160788, g: 0.121665, b: 0.009716179 }
    },
  ])('should generate the same Color (error margin 0.00005%) when given ranges - [Seed: $init]',
  ...
  test.each([
    {
      ...
      hueMin: 0.4776986,
      hueMax: 0.5658471,
      saturationMin: 0.1417581,
      saturationMax: 0.7545162,
      valueMin: 0.2890312,
      valueMax: 0.8724657,
      alphaMin: 0.09216214,
      alphaMax: 0.9967413,
    ...
    },
    {
      ...
      hueMin: 0.3103028,
      hueMax: 0.6900989,
      saturationMin: 0.2188076,
      saturationMax: 0.4164305,
      valueMin: 0.1378517,
      valueMax: 0.7215825,
      alphaMin: 0.09216214,
      alphaMax: 0.9967413,
  ...
  ])('should generate the same Color (error margin 0.00005%) when ranges, with alpha range [r:$expected.r, g:$expected.g, b:$expected.b] - [Seed: $init]',
